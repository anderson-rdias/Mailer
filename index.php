...
$mail->Username = 'formularoteste@btmachado.com.br';       // Conta de e-mail que realizará o envio
...
$mail->From = 'formularoteste@btmachado.com.br'; 			// e-mail From deve ser o mesmo de "username" (contadeEmail)
$mail->FromName = 'Teste'; 				// Nome que será exibido ao receber a mensagem. 
$mail->addAddress('formularoteste@btmachado.com.br', 'Alexandre'); // Destinatário 
